...
<html>
          ...
          function drawDocumentFrequencyChart() {
            ...
            function selectHandlerDocFreq() {
              ...
              if (selectedItem) {
                ...
                $('#year').val( data.getValue(selectedItem.row, 0) )
                $('#key').val( keywords[selectedItem.column - 1] )
                $('#textUnit').val('document')
                $('#hiddenSubmit').click()
              }
            }
    ...
    <body>
      <g:form action="filterTextUnits">
        <g:hiddenField id="year" name="year" value="" />
        <g:hiddenField id="textUnit" name="textUnit" value="" />
        <g:hiddenField id="key" name="key" value ="" />
        <g:hiddenField id="corpusId" name="corpusId" value="${params.corpusId}" />
        <g:hiddenField id="query" name="query" value="${params.query}" />
